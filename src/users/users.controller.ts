...
export class UsersController {
    ...
    @Post()
    createUser(@Body()NewUserData:{name: string, surname:string, email:string, phoneNumber?:string, password: string, role:"owner"|"tenant"|"admin"}): Promise<UserDTO|null>{
    ...
    updateUser(@Param('id')id:string, @Body()updatedUserData:{name?: string, surname?:string, email?:string, phoneNumber?:string, password?: string, role?:"owner"|"tenant"|"admin"}): Promise<UserDTO|null> {
