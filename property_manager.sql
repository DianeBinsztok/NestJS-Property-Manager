...
CREATE TABLE owner_has_location (
  ...
  `owner_has_location_created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `owner_has_location_updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE tenant_has_location (
  ...
  `tenant_has_location_created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `tenant_has_location_updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
